...
For a collapsible docked chat, use [CopilotSidebar](/strands/prebuilt-components/sidebar).
For a floating bubble that overlays content, use [CopilotPopup](/strands/prebuilt-components/popup).
For saved conversations and switching between prior conversations, drop in the [Threads Drawer](/strands/prebuilt-components/copilot-threads-drawer) (or go headless with [Headless Threads](/strands/headless-threads)).
...
| `messageView` | Slot for the message list — see [slots](/strands/custom-look-and-feel/slots). |
...
- **CSS variables / class overrides** — see [CSS customization](/strands/custom-look-and-feel/css)
- **Slots (subcomponents)** — see [slots](/strands/custom-look-and-feel/slots)
- **Fully headless** — see [headless UI](/strands/custom-look-and-feel/headless-ui)
