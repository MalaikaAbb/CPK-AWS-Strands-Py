...
[Headless Threads](/strands/headless-threads)). Thread **rename** is one of those headless
...
- [Rich Threads overview](/strands/threads): compare thread UI and deployment paths
- [Headless Threads](/strands/headless-threads): build a custom UI with the `useThreads` data layer
- [Threads Drawer reference (React)](/reference/components/CopilotThreadsDrawer)
- [CopilotChat](/strands/prebuilt-components/chat): the chat the drawer connects to
