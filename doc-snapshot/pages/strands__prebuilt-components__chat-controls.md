...
- [CopilotPopup](/strands/prebuilt-components/popup) and [CopilotSidebar](/strands/prebuilt-components/sidebar): the prebuilt surfaces that own modal state.
...
- [Slots](/strands/custom-look-and-feel/slots): the `messageView` / `assistantMessage` slot system used above.
- [Programmatic Control](/strands/programmatic-control): driving agent runs from code without a chat UI.
