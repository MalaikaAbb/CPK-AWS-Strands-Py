...
- The [slot system](/strands/custom-look-and-feel/slots) isn't enough: you need a completely different layout.
...
- [Slots](/strands/custom-look-and-feel/slots) — less work than going fully headless, often enough.
- [CSS customization](/strands/custom-look-and-feel/css) — when you just need to re-skin the defaults.
