...
<!-- setup skipped: agent-context-setup is not bundled for strands -->
...
**[shared state](/strands/shared-state)** instead.

## Related

- **[Shared State (overview)](/strands/shared-state)** — bidirectional
  reads + writes.
