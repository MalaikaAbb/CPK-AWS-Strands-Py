...
[CopilotPopup](/strands/prebuilt-components/popup). For a fully embedded chat pane,
...
| `header` | Slot for the sidebar header bar — see the [slot system](/strands/custom-look-and-feel/slots). |
