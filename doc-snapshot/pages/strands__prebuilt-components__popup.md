...
use [CopilotSidebar](/strands/prebuilt-components/sidebar). For a fully embedded
chat pane, use [`<CopilotChat>`](/strands/prebuilt-components/chat) directly.
...
| `header` | Slot for the popup header bar — see the [slot system](/strands/custom-look-and-feel/slots). |
...
[custom look and feel](/strands/custom-look-and-feel/slots) for the full slot
reference.
